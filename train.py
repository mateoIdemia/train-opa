...
def build_dataset(config):
    ...
    dsTrain = ImageFolder('data/ds_1/train/', train_transforms, target_transform=target_transform)
    dsVal = ImageFolder('data/ds_1/test/', val_transforms, target_transform=target_transform)
